...
export const DEFAULTS: Settings = { apiBase: '', clientKey: '', testMode: false, testDomain: '', testAccountUrl: '', testName: 'Test service', watch: false, maxSteps: 25, skipPayment: true };
